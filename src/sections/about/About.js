      ...
      <div className="container about__container">
        <div className="about__left">
          <div className="about__portrait">
            <img src={aboutimg} alt="aboutphoto" className="aboutmg" />
          </div>
        </div>
        <div className="about__right">
          ...
          <p>
            Hi, my name is Abiodun Labinjo from Lagos, Nigeria. I'm a full stack
            web developer with a bachelors degree in Economics. My top priority
            is to get your business online the right way, giving you industry
            standard design and all the functionality you need to operate
